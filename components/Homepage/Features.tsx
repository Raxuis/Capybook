            ...
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <motion.p className="text-xl text-muted-foreground max-w-2xl mx-auto"
                        ...
                        Découvrez comment LivreTrack transforme votre expérience de lecture avec ces fonctionnalités
                        essentielles.
                    </motion.p>
                </motion.div>
                                ...
                                currentTab === key ? (
                                    <motion.div key={key} initial="hidden" animate="visible" exit="exit"
                                        ...
                                        <TabsContent value={key}>
                                            <div className="grid md:grid-cols-2 gap-8 justify-items-between items-center w-full">
                                            <div className="space-y-4 justify-self-start">
                                                    <motion.div className="inline-block p-3 bg-primary/10 rounded-2xl"
                                                ...
                                                <motion.div
                                                    className="bg-muted rounded-2xl p-6 aspect-square flex items-center justify-center w-1/2 md:justify-self-end"
